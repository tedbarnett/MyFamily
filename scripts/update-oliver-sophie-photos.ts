...
async function main() {
  const updates = [
    { id: '34a6557d-4046-4acf-b5cb-36633e98ddf7', name: 'Oliver', path: 'attached_assets/generated_images/oliver_at_bat_baseball.png' },
    { id: '6597dc17-21c2-4119-9977-155acff0436d', name: 'Sophie', path: 'attached_assets/generated_images/sophie_holding_cloth_doll.png' },
  ];
